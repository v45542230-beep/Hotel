...
namespace Hotel.Models
{
    public class Clients
    {
        ...
        [Required(ErrorMessage = "Пожалуйста, введите номер карты")]
        [RegularExpression(@"^\d{4}\-\d{4}\-\d{4}\-\d{4}$", ErrorMessage = "Вы ввели некорректный номер карты")]
        [StringLength(19, MinimumLength = 19, ErrorMessage = "Минимальное количество символов: 19")]
        ...
        [StringLength(50, MinimumLength = 0, ErrorMessage = "Минимальное количество символов: 20")]
